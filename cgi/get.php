...
$script_name = $_SERVER['SCRIPT_NAME']    ?? '/cgi/get_test.php';
...
if ($method === 'GET') {
    ...
    $env_html .= env_line('QUERY_STRING',$query_str ?: '(empty)');
    ...
    $body_html .= result_row('example',  $script_name . '?name=john&age=30');
